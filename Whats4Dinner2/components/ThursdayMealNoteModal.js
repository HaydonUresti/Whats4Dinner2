...
const ThursdayMealNoteModal = ({visible, whatDay, onClose}) => {
    ...
    const titleDayReference = firebase.firestore().collection('ThursdayTitleData').doc('FriayTitle');
    const descriptionDayReference = firebase.firestore().collection('ThursdayDescriptionData').doc('ThursdayDescription');
