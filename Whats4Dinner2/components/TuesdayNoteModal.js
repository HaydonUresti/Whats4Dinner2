...
const TuesdayMealNoteModal = ({visible, whatDay, onClose}) => {
    ...
    const titleDayReference = firebase.firestore().collection('TuesdayTitleData').doc('FriayTitle');
    const descriptionDayReference = firebase.firestore().collection('TuesdayDescriptionData').doc('TuesdayDescription');
