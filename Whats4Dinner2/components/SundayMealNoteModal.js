...
const SundayMealNoteModal = ({visible, whatDay, onClose}) => {
    ...
    const titleDayReference = firebase.firestore().collection('SundayTitleData').doc('FriayTitle');
    const descriptionDayReference = firebase.firestore().collection('SundayDescriptionData').doc('SundayDescription');
