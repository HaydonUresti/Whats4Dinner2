...
const SaturdayMealNoteModal = ({visible, whatDay, onClose}) => {
    ...
    const titleDayReference = firebase.firestore().collection('SaturdayTitleData').doc('FriayTitle');
    const descriptionDayReference = firebase.firestore().collection('SaturdayDescriptionData').doc('SaturdayDescription');
